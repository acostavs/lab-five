...
function sum(a, b) { //eslint-disable-line
    let myString = `The sum of ${a} and ${b} is ${a + b}.`
    let mySum = [a + b, myString]
    // console.log(mySum)
    return mySum
...
function multiply(a, b) { //eslint-disable-line
    let mySecondString = `The product of ${a} and ${b} is ${a * b}.`
    let mySecondSum = [a * b, mySecondString]
...
returns an array where the first element is the sum of the numbers in the array, 
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    let idk = parseInt(sum(2, 3))
    let idkTwo = parseInt(sum(idk, 4))
    // console.log(idkTwo)
